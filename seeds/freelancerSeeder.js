...
module.exports = async () => {
    ...
    const firstNames = ['علیرضا', 'فرزانه', 'امیر', 'محسن', 'رویا', 'پردیس', 'مهدیس', 'مهدیه', 'مریم', 'سعید', 'رامین', 'علی', 'محمد'];
    const lastNames = ['محسنی', 'حسینی', 'پور رضا'];
    const tagLines = ['برنامه نویس', 'مهندس', 'مترجم', 'محقق'];
    for (let i = 0; i < 100; i++) {
        freelancers.push({
            email: faker.internet.email(),
            password: '12345678',
            first_name: faker.random.arrayElement(firstNames),
